...
namespace RE
{
	...
	[[deprecated]] void BSResourceNiBinaryStream::Seek(std::ptrdiff_t a_numBytes)
	{
	...
	[[deprecated]] std::size_t BSResourceNiBinaryStream::DoRead(void* a_buf, std::size_t a_toRead)
	{
	...
	[[deprecated]] std::size_t BSResourceNiBinaryStream::DoWrite(const void* a_buf, std::size_t a_toWrite)
	{
	...
	[[deprecated]] void BSResourceNiBinaryStream::GetBufferInfo([[maybe_unused]] BufferInfo& a_buf)
	{
	...
	[[deprecated]] BSResourceNiBinaryStream* BSResourceNiBinaryStream::ctor(const char* a_name, bool a_writeable, BSResource::Location* a_optionalStart, bool a_fullReadHint)
	{
	...
	[[deprecated]] void BSResourceNiBinaryStream::dtor()
	{
	...
	[[deprecated]] [[nodiscard]] BSResourceNiBinaryStream* BSResourceNiBinaryStream::BinaryStreamWithRescan(const char* a_fileName)
	{
