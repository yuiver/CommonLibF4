	...
	namespace BSScript
	{
		...
		namespace Internal
		{
			...
			public:
				...
				// TODO: Compare below with implementation in papyrus-debug-server old ver
				// override (IFunction)
				...
				// TODO: Does this take in a TypeInfo& and return a ref instead of a value?
				...
				// TODO: does this actually return anything? or are the params the only thing?
				...
				// TODO: This probably isn't const, also check if reference or pointer
				virtual void					InsertLocals(StackFrame& a_frame) const override;																		// 0E
				// TODO: Verify if logger and vm are refs or pointers
