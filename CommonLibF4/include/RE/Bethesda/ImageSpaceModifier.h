...
namespace RE
{
	...
	public:
		...
		[[deprecated]] static ImageSpaceModifierInstanceForm* Trigger(TESImageSpaceModifier* a_mod, float a_strength, NiAVObject* a_target)
		{
		...
		[[deprecated]] static ImageSpaceModifierInstanceForm* Trigger(const BSFixedString& a_name)
		{
		...
		[[deprecated]] static void Stop(TESImageSpaceModifier* a_mod)
		{
		...
		[[deprecated]] static void Stop(const BSFixedString& a_name)
		{
